...
public class CharacterStatsApp {
    ...
    public static void writeToCSV(String fileName, List<CharacterStats> statsList) throws IOException {
 ...
 * @throws IOException Signals that an I/O exception has occurred.
 */
    public static void modifyLine(String fileName, int lineNumber, List<CharacterStats> statsList) throws IOException {
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public static List<CharacterStats> readFromCSV(String fileName) throws IOException {
